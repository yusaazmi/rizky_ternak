...
<!-- Bread crumb and right sidebar toggle -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <form action="simpan_editayam.php" method="POST">
                            <input type="hidden" name="id_ayam" value="<?php echo $data['id_ayam'];?>">
                            <div class="card-body">
                                <h5 class="card-title">Form Update Ayam</h5>
                                ...
                                <div class="row mb-3 align-items-center">
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <input type="text" data-toggle="tooltip" class="form-control" name="ukuran" id="ukuran" required value="<?php echo $data['ukuran'];?>">
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    <div class="col-lg-4 col-md-12 text-right">
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <input type="text" data-toggle="tooltip" class="form-control" name="harga" id="harga" required value="<?php echo $data['harga'];?>">
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    <div class="col-lg-4 col-md-12 text-right">
                                    ...
                                    <div class="col-lg-8 col-md-12">
                                        <input type="text" data-toggle="tooltip" class="form-control" name="deskripsi" id="deskripsi" required value="<?php echo $data['deskripsi'];?>">
                                    </div>
                                </div>
